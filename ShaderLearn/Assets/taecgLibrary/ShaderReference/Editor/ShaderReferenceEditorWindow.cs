...
namespace taecg.tools.shaderReference
{
    public class ShaderReferenceEditorWindow : EditorWindow
    {
        ...
        private string[ ] tabNames = new string[ ] { "GPU", "Pipline", "Properties", "Semantics", "Tags", "Render State", "Compile Directives", "Other", "BuildIn Variables", "BuildIn Functions", "Predefined Macros", "Math", "Lighting", "Miscellaneous", "Error Debug", "GLSL", "Setup", "About" };
